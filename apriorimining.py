...
def start():
    ...
    if("MovieLensData.txt" in filename):
        printNames = raw_input("Do you want to print sets and rules with Movie names in stead of numbers? For this option, u.item should be included in the folder. [y/n]: ")
